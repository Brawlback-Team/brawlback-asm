...
void Message::setup() {
    //save font values
    void* savedFont1 = _FONT_THING1;
    void* savedFont2 = _FONT_THING2;
...
void Message::setObjZCompare(int unk1, bool active) {
    setObjZcompare(this, unk1, active);
}
...
void TextPrinter::setup() {
    ...
    void* savedFont1 = _FONT_THING1;
    void* savedFont2 = _FONT_THING2;
    float savedFontScaleX = message.fontScaleX;
    float savedFontScaleY = message.fontScaleY;
